<?php $__env->startSection('title', 'Privacy Policy — Keysol Agro'); ?>
<?php $__env->startSection('meta_description', 'Keysol Agro Privacy Policy — how we collect, use and protect your personal data when you visit our website or contact us.'); ?>
    ...
    <div class="container mx-auto px-6">
        <div style="max-width:760px; margin:0 auto;">
            ...
            <p style="font-size:1.05rem; line-height:1.85; color:#374151; margin-bottom:2.5rem; padding-bottom:2.5rem; border-bottom:1px solid #e5e7eb;">
                ...
                <strong><?php echo e(config('app.url')); ?></strong>, how we use it and what rights you have.
            ...
            <div style="margin-bottom:2.5rem;">
                ...
                <div style="background:#f9fafb; border:1px solid #e5e7eb; border-radius:1rem; padding:1.5rem 2rem; display:inline-block;">
                    <p style="margin:0; color:#374151; line-height:1.9;">
                        ...
                        Website: <a href="<?php echo e(config('app.url')); ?>" style="color:#16a34a; text-decoration:none;"><?php echo e(config('app.url')); ?></a>
                    </p>
                </div>
            </div>
...
<section style="background:#f9fafb; border-top:1px solid #e5e7eb; padding:60px 0;">
    <div class="container mx-auto px-6" style="text-align:center;">
        ...
        <a href="<?php echo e(lroute('contact')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/privacy.blade.php ENDPATH**/ ?>