<?php $__env->startSection('title', 'Terms of Use — Keysol Agro'); ?>
<?php $__env->startSection('meta_description', 'Keysol Agro Terms of Use — the rules and conditions that govern your use of our website and services.'); ?>
    ...
    <div class="container mx-auto px-6">
        <div style="max-width:760px; margin:0 auto;">
            ...
            <p style="font-size:1.05rem; line-height:1.85; color:#374151; margin-bottom:2.5rem; padding-bottom:2.5rem; border-bottom:1px solid #e5e7eb;">
                By accessing or using the website located at <strong><?php echo e(config('app.url')); ?></strong>
            ...
            <div style="margin-bottom:2.5rem;">
                ...
                <p style="color:#4b5563; line-height:1.8;">
                    ...
                    <a href="<?php echo e(lroute('privacy')); ?>" style="color:#16a34a; text-decoration:none; font-weight:600;"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/pages/terms.blade.php ENDPATH**/ ?>