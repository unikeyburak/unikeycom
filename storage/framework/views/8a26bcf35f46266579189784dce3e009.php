...
<div
    ...
    role="dialog"
    aria-label="<?php echo e(__('Çerez Bildirimi')); ?>"
>
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <div class="flex items-start gap-3 flex-1">
                ...
                <p class="text-sm text-gray-300 leading-relaxed">
                    <?php echo e(__('Size daha iyi hizmet sunabilmek için çerezler kullanıyoruz. Sitemizi kullanmaya devam ederek')); ?>

                    <a href="<?php echo e(lroute('privacy')); ?>"
                       class="text-cyan-400 hover:text-cyan-300 underline underline-offset-2 transition-colors">
                        <?php echo e(__('Gizlilik Politikamızı')); ?>

                    </a>
                    <?php echo e(__('kabul etmiş sayılırsınız.')); ?>
...
<?php /**PATH /var/www/html/resources/views/partials/cookie-consent.blade.php ENDPATH**/ ?>