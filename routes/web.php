...
// Varsayılan dili döngüde EN SONA al. Varsayılan dil prefix'siz olduğu için onun
// kök catch-all'ı (Route::get('{slug}')) daha sonra kayıtlanan dillerin kök URL'lerini
// (/en, /fr, /es, /ar) "slug" sanıp yutuyor ve 404 üretiyordu. Varsayılan grubu en sona
// alınca, lokalize kök home route'ları catch-all'dan ÖNCE kayıtlanır ve doğru eşleşir.
$activeLocales = array_merge(
    array_values(array_diff($activeLocales, [$defaultLocale])),
    [$defaultLocale]
);
